...
CLASS lhc_holidayroot IMPLEMENTATION.
  ...
  METHOD augment_create.
    DATA: text_cba TYPE TABLE FOR CREATE zcal_i_holiday_dvt\_holidaytxt,
    ...
    MODIFY AUGMENTING ENTITIES OF zcal_i_holiday_dvt ENTITY holidayroot CREATE BY \_holidaytxt
    FROM text_cba
    RELATING TO entities BY myrelates.
  ENDMETHOD.

  METHOD augment_update.
    DATA: text_update TYPE TABLE FOR UPDATE zcal_i_holidaytxt_dvt,
          text_cba   TYPE TABLE FOR CREATE zcal_i_holiday_dvt\_holidaytxt.
    DATA: myrelates_update TYPE abp_behv_relating_tab,
          myrelates_cba   TYPE abp_behv_relating_tab.

    READ ENTITIES OF zcal_i_holiday_dvt
    ...
    MODIFY AUGMENTING ENTITIES OF zcal_i_holiday_dvt
